...
{addJsDef RELAISCOLIS_ID=0}
{addJsDef RELAISCOLIS_ID_MAX=0}
...
<img src="{$url_img|escape:'htmlall':'UTF-8'}rc_petit_logo.png" alt="logo relaiscolis"/>
<p class="alert alert-warning">
    {if $message1 != ""}
        {$message1|escape:'htmlall':'UTF-8'}<br/><br/>
    {/if}

    {if $message2 != ""}
        {$message2|escape:'htmlall':'UTF-8'}<br/>
    {/if}
</p>
<br/>
